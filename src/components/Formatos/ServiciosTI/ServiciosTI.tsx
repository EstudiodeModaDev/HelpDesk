...
export default function SolicitudUsuarioForm({
  ...
  return (
    <form className="su-card su-form" onSubmit={submit} noValidate>
      ...
      <div className="su-left">
        ...
        <div className="su-field">
          ...
          <select
            value={form.contratacion}
            onChange={onChange("contratacion")}
            required
          >
        ...
        <div className="su-field">
          ...
          <input
            ...
            onChange={onChange("centroCostos")}
            required
          />
        </div>
        ...
        <div className="su-field">
          ...
          <input
            type="text"
            inputMode="numeric"
            value={form.centroOperativo}
            onChange={onChange("centroOperativo")}
            required
          />
        </div>
      </div>
      ...
      <div className="su-right">
        ...
        <div className="su-field su-field--extension">
          ...
          <select
            value={form.extensionTelefonica}
            onChange={onChange("extensionTelefonica")}
            required
          >
