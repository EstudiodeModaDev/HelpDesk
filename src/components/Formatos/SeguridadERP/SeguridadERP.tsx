import { useSolicitudesERP } from "../../../Funcionalidades/SolicitudERP";
import type { FilaSolicitudERP } from "../../../Models/Formatos";
import "./SeguridadERP.css";

type Props = {
  onSubmit: (payload: Omit<FilaSolicitudERP, "id">[]) => Promise<void> | void;
};

export default function SolicitudERP({ onSubmit }: Props) {
  const {
    filas, sending, error, addFila, removeFila, setCampo, submit,
  } = useSolicitudesERP(onSubmit);

  return (
    <section className="erp-scope">
      <form className="erp-card" onSubmit={submit} noValidate>
          ...
          {filas.map((f) => (
            <div className="erp-row" role="row" key={f.id}>
              <div className="erp-cell" role="cell">
                <input
                  className="erp-input"
                  value={f.nombreperfil}
                  onChange={(e) => setCampo(f.id, "nombreperfil", e.target.value)}
                  placeholder=""
                />
              </div>
              ...
              <div className="erp-cell" role="cell">
                <input
                  className="erp-input"
                  value={f.metodogeneral}
                  onChange={(e) => setCampo(f.id, "metodogeneral", e.target.value)}
                  placeholder=""
                />
              </div>
              ...
              <div className="erp-cell" role="cell">
                <input
                  className="erp-input"
                  value={f.metodoespecifico}
                  onChange={(e) => setCampo(f.id, "metodoespecifico", e.target.value)}
                  placeholder=""
                />
              </div>
              ...
              <div className="erp-cell" role="cell">
                <input
                  className="erp-input"
                  value={f.permisoespecifico}
                  onChange={(e) => setCampo(f.id, "permisoespecifico", e.target.value)}
                  placeholder=""
                />
              </div>
              ...
              <div className="erp-cell" role="cell">
                <input
                  className="erp-input"
                  value={f.usuarioNombre}
                  onChange={(e) => setCampo(f.id, "usuarioNombre", e.target.value)}
              ...
              <div className="erp-cell" role="cell">
                <input
                  ...
                  type="email"
                  value={f.usuarioMail}
                  onChange={(e) => setCampo(f.id, "usuarioMail", e.target.value)}
