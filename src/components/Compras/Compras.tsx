...
/** Util: objeto con todas las marcas en 0% */
...
export default function CompraFormulario({ onSubmit, initial }: Props) {
  ...
  // Si cambia a "CO", limpia todos los % (todas las marcas a 0)
  React.useEffect(() => {
    if (state.cargarA === "CO") {
  ...
  // Cuando "Cargar a = CO": mostrar el label del CO seleccionado
  ...
  return (
    <div className="compra-form white-silo" data-darkreader-ignore>
