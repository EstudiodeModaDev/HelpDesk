// Funcionalidades/tickets/Escalamiento.ts
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await logs?.createLog({
        ...
        seguimientos_solvi_descripcion: `Se diligenció acta para ${state.persona} (${state.tipoUsuario})`,
        seguimientos_solvi_id_ticket: Number(state.numeroTicket),
