...
export class ProveedoresFacturaService {
  ...
  // ---------- CRUD ----------
  async create(record: Omit<Proveedor, 'ID'>) {
  ...
  async update(id: string, changed: Partial<Omit<Proveedor, 'ID'>>) {
    await this.ensureIds()
